...
$i++;
$cfg['Servers'][$i]['host'] 			= 'mysql-cluster-1-mysql-master.database.svc.cluster.local';
$cfg['Servers'][$i]['port'] 			= '3306';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= '2\'m:;gI+5`(hs3j?^eMvoUE5Pu!-\"t9l' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_Wtp1w50X6GMOsZrx8PF4jz3/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://kleeblatt.games/wp-admin/?rand=65592007&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://kleeblatt.games/wp-admin/?rand=74048960&pma_logout=1';
